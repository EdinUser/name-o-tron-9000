# Name-o-Tron 9000 — Developer Docs

This folder contains contributor-facing documentation that assumes access to the repository and build tooling. These files are not published to the public MkDocs site served at https://name-o-tron.kirilov.dev/.

- `appendix_build.md` — build from source, dev environment, CI notes
